    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between p-2 bg-card border border-border rounded-lg">
        ...
        <Switch
          ...
          onCheckedChange={(val) =>
            setPostData({ ...postData, isVerified: val })
          }
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) =>
              setPostData({ ...postData, replies: e.target.value })
            }
            className="h-8 text-xs bg-card border-border rounded-lg"
          />
        </div>
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) =>
              setPostData({ ...postData, retweets: e.target.value })
            }
            className="h-8 text-xs bg-card border-border rounded-lg"
          />
        </div>
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) =>
              setPostData({ ...postData, likes: e.target.value })
            }
            className="h-8 text-xs bg-card border-border rounded-lg"
          />
        </div>
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) =>
              setPostData({ ...postData, bookmarks: e.target.value })
            }
            className="h-8 text-xs bg-card border-border rounded-lg"
          />
        </div>
        <div className="space-y-1 col-span-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setPostData({ ...postData, views: e.target.value })
            }
            className="h-8 text-xs bg-card border-border rounded-lg"
          />
        </div>
